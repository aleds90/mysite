...
<!-- Navigation Bar on Top -->
 ...
 <!-- Area login -->
 	<div id="login" style="display: none;" style="text-align: center;"  tabindex="-1" role="dialog" >
		<form id="form-login" action = "/MySite/login" method="POST">
			<input style="text-align: center; margin: auto; width:300px;" path="username" type = "text" id = "login" placeholder = "Username" name = "username">
            <input style="text-align: center; margin: auto; width:300px;" path="password" type = "text" id = "password" placeholder = "Password" name = "password">
